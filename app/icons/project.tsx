export const ProjectNameIcon = ({ size }) => (
    <svg
        style='margin:0 5px;'
        stroke='currentColor'
        fill='currentColor'
...
export const ProjectLocation = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const ProjectArea = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const ProjectStartPrice = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const ProjectDescription = ({ size }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const ProjectStar = ({ size = 25 }) => (
    <svg
        class='star-svg'
        stroke='currentColor'
        fill='currentColor'
